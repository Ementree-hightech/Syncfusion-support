...
export let fifaEventsData: Object[] = [
  {
    ...
    Description: 'Group A',
    StartTime: new Date(2018, 5, 14, 1, 0),
    EndTime: new Date(2018, 5, 14, 10, 0),
    ...
    Description: 'Group A',
    StartTime: new Date(2018, 5, 14, 2, 0),
    EndTime: new Date(2018, 5, 14, 8, 0),
    ...
    Description: 'Group A',
    StartTime: new Date(2018, 5, 14, 8, 0),
    EndTime: new Date(2018, 5, 14, 14, 0),
    StartTimezone: 'Europe/Moscow',
    EndTimezone: 'Europe/Moscow',
